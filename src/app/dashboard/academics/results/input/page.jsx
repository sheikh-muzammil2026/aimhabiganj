...
const CLASS_SUBJECTS = {
    "প্লে": ["কুরআন-০১", "ইংরেজি", "বাংলা", "গণিত"],
    "নার্সারি": ["কুরআন -০২", "ইংরেজি", "বাংলা", "গণিত"],
    "প্রথম": ["কুরআন-০৩", "আরবি", "আকিদাহ ও ফিকহ-১", "ইংরেজি", "বাংলা", "গণিত", "সাধারণ জ্ঞান"],
    "দ্বিতীয়": ["কুরআন-০১ ও তাজভীদ", "আরবি", "আকিদাহ ও ফিকহ-২", "ইংরেজি", "বাংলা", "গণিত", "সাধারণ জ্ঞান"],
    "তৃতীয়": ["হিফজুল কুরআন-১", "আরবি", "আদব ও দোয়া", "আকিদাহ ও ফিকহ-৩", "ইংরেজি", "বাংলা", "গণিত", "সাধারণ জ্ঞান/ বা ও বি", "বিজ্ঞান", "হাতের লেখা"],
    "চতুর্থ": ["হিফজুল কুরআন-২ ও তাজবীদ", "আরবি", "আকিদাহ ও ফিকহ-৪", "ইংরেজি", "বাংলা", "গণিত", "বিজ্ঞান/ বাংলাদেশ ও বিশ্ব পরিচয়", "আদাব ও দোয়া", "এসো তামরিন"],
    "পঞ্চম": ["হিফজুল কুরআন-৩ ও তাজবীদ", "আরবি", "তামরিন", "সরফ", "আকিদাহ ও ফিকহ-৪", "ইংরেজি", "বাংলা", "গণিত", "বিজ্ঞান"],
    "ষষ্ঠ": ["হিফজুল কুরআন-৪", "কুরআন অনুবাদ", "হাদিস", "আরবি", "সরফ", "নাহু", "তাওহিদ ও ফিকহ-৪", "ইংরেজি ১ম ও ২য়", "বাংলা ১ম ও ২য়", "গণিত", "বিজ্ঞান"],
    "সপ্তম": ["হিফজুল কুরআন-৪", "কুরআন অনুবাদ", "হাদিস", "আরবি", "আরবি সাহিত্য", "সরফ", "নাহু", "তাওহীদ", "ফিকহ", "ইংরেজি ১ম ও ২য়", "বাংলা ১ম ও ২য়", "গণিত", "বিজ্ঞান"],
