...
const CLASS_SUBJECTS = {
    ...
    "প্রথম": ["কুরআন-০১ ও তাজভীদ", "আরবি", "তাওহীদ ও ফিকহ-১", "ইংরেজি", "বাংলা", "গণিত", "সাধারণ জ্ঞান"],
    "দ্বিতীয়": ["কুরআন-০২ ও তাজভীদ", "আরবি", "তাওহীদ ও ফিকহ-২", "ইংরেজি", "বাংলা", "গণিত", "সাধারণ জ্ঞান"],
    "তৃতীয়": ["কুরআন-০৩ ও তাজভীদ", "আরবি", "আদব ও দোয়া", "তাউহিদ ও ফিকহ-৩", "ইংরেজি", "বাংলা", "গণিত", "বাংলাদেশ ও বিশ্বপরিচয়", "বিজ্ঞান", "হাতের লেখা"],
    "চতুর্থ": ["কুরআন-০৪ ও তাজভীদ", "আরবি", "তাওহীদ ও ফিকহ-৩", "ইংরেজি", "বাংলা", "গণিত", "বাংলাদেশ ও বিশ্ব পরিচয়", "আদাব ও দোয়া", "এসো তামরিন শিখি"],
    "পঞ্চম": ["কুরআন-০৫ ও তাজভীদ", "আরবি", "তামরিন", "সরফ", "তাওহীদ ও ফিকহ-৪", "ইংরেজি", "বাংলা", "গণিত", "বিজ্ঞান"],
    "ষষ্ঠ": ["হিফজুল কুরআন-০১ ও তাজভীদ", "কুরআন অনুবাদ", "হাদিস", "আরবি", "সরফ", "নাহু", "তাওহীদ ও ফিকহ-৫", "ইংরেজি ১ম ও ২য়", "বাংলা ১ম ও ২য়", "গণিত", "বিজ্ঞান"],
    "সপ্তম": ["হিফজুল কুরআন-০২ ও তাজভীদ", "কুরআন অনুবাদ", "হাদিস", "আরবি", "আরবি সাহিত্য", "সরফ", "নাহু", "তাওহীদ", "ফিকহ", "ইংরেজি ১ম ও ২য়", "বাংলা ১ম ও ২য়", "গণিত", "বিজ্ঞান"],
    "অষ্টম": ["হিফজুল কুরআন-০৩ ও তাজভীদ", "কুরআন অনুবাদ", "হাদিস", "উসুলুল হাদিস", "আরবি", "সরফ", "নাহু", "তাওহীদ", "ফিকহ", "ইংরেজি ১ম ও ২য়", "বাংলা ১ম ও ২য়", "গণিত", "বিজ্ঞান"],
