                ...
                <header className="bg-white dark:bg-[#0f172a] border-b border-emerald-900/10 dark:border-emerald-950/30 h-16 px-4 sm:px-6 flex items-center justify-between sticky top-0 z-30 shadow-xs flex-shrink-0 print:hidden">
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <div className="flex flex-col">
                            ...
                            <h2 className="font-black text-sm text-emerald-900 dark:text-emerald-400 tracking-wide lg:hidden block">
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <button className="relative p-2 text-slate-500 dark:text-slate-400 hover:text-emerald-800 dark:hover:text-emerald-400 transition-colors focus:outline-hidden" title="নোটিফিকেশন">
