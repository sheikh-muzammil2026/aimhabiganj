...
export default function AboutPage() {
  ...
  return (
    <div className="scroll-smooth min-h-screen bg-gray-50 dark:bg-slate-900">
      <section id="profile" className="py-16 border-b border-gray-100 dark:border-slate-800/60">
        <Profile data={aboutData?.profile} />
      </section>

      <section id="founder" className="py-16 border-b border-gray-100 dark:border-slate-800/60 bg-emerald-50/10 dark:bg-slate-900/40">
        <Founder data={aboutData?.founder} />
      </section>

      <section id="vision" className="py-16 border-b border-gray-100 dark:border-slate-800/60">
        <Vision data={aboutData?.vision} />
      </section>

      <section id="committee" className="py-16 border-b border-gray-100 dark:border-slate-800/60 bg-emerald-50/10 dark:bg-slate-900/40">
        <Committee data={aboutData?.committee} />
      </section>

      <section id="features" className="py-16 border-b border-gray-100 dark:border-slate-800/60">
        <Features data={aboutData?.features} />
      </section>

      <section id="roadmap" className="py-16 border-b border-gray-100 dark:border-slate-800/60 bg-emerald-50/10 dark:bg-slate-900/40">
        <Roadmap data={aboutData?.roadmap} />
      </section>

      <section id="testimonials" className="py-16 border-b border-gray-100 dark:border-slate-800/60">
        <Testimonials data={aboutData?.testimonials} />
      </section>

      <section id="policies" className="py-16 bg-emerald-50/10 dark:bg-slate-900/40">
