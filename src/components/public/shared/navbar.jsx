  ...
  return (
    <>
          ...
          <div className="flex items-center justify-center h-20">
            ...
            <div className="hidden lg:flex items-center">
                    ...
                    <>
                      <button
                        ...
                        className={`px-2 py-2 rounded-md text-[13px] xl:text-sm font-semibold hover:bg-emerald-800/80 dark:hover:bg-slate-800/80 transition flex items-center gap-0.5 focus:outline-none text-white ${
                          item.isAdmission
                            ? "bg-amber-500 hover:bg-amber-600 text-slate-950 dark:text-slate-950 animate-pulse rounded-md px-3 font-bold"
                            : ""
                        }`}
                      >
                        {item.name}
                        <svg
                          className={`w-3 h-3 ${item.isAdmission ? "text-slate-950" : "text-emerald-200/70"}`}
                          fill="none"
                          stroke="currentColor"
                          viewBox="0 0 24 24"
                        >
              ...
              <button
                ...
                className="p-1.5 ml-1 rounded-full hover:bg-emerald-800/80 dark:hover:bg-slate-800/80 transition-colors text-amber-300 focus:outline-none flex-shrink-0"
              >
                {darkMode ? (
                  <svg
                    className="w-4 h-4"
                  ...
                  >
                    <path
                      ...
                      strokeLinejoin="round"
                      strokeWidth="2"
                      d="M12 3v1m0 16v1m9-9h-1M4 12H3m15.364-6.364l-.707.707M6.343 17.657l-.707.707M16.243 17.657l.707.707M6.343 6.343l.707-.707M12 12a9 9 0 110 18v-1z"
                    />
                  </svg>
                ) : (
                  <svg
      ...
      {isOpen && (
        ...
        >
          <div
            className="absolute top-24 right-4 w-64 bg-emerald-950/95 border border-emerald-800 rounded-2xl shadow-2xl p-4 space-y-3 dark:bg-slate-950/95 dark:border-slate-800 animate-in fade-in zoom-in-95 duration-150"
...
function GlobalMobileNavTrigger({
  isOpen,
  setIsOpen,
  darkMode,
  toggleDarkMode,
