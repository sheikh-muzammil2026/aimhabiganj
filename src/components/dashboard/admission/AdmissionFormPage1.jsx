      ...
      <div className="w-full min-h-[11.69in] bg-white p-4 md:p-10 flex flex-col justify-between box-border text-gray-800 relative font-bengali overflow-x-hidden print:min-h-0 print:h-full print:p-0 print:overflow-hidden">
        ...
        <div className="w-full mb-4 print:mb-2">
          ...
          <div className="space-y-4 print:space-y-2.5">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 items-end print:grid-cols-4 print:gap-2">
            ...
            <div className="space-y-2 pt-1">
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 gap-3 items-end pl-0 md:pl-4 print:grid-cols-3 print:gap-2 print:pl-2">
                <div className="flex items-center gap-2">
                  ...
                  <select name="currentAddress.district" value={formData.currentAddress?.district || ""} onChange={handleChange} className="flex-1 border border-gray-400 rounded p-0.5 text-sm bg-white print:text-xs">
                    <option value="">বাছাই করুন</option>
                ...
                <div className="flex items-center gap-2">
                  ...
                  <select name="currentAddress.thana" value={formData.currentAddress?.thana || ""} onChange={handleChange} className="flex-1 border border-gray-400 rounded p-0.5 text-sm bg-white print:text-xs" disabled={!formData.currentAddress?.district}>
                    <option value="">বাছাই করুন</option>
        ...
        <div className="w-full mb-4 print:mb-2">
          ...
          <div className="overflow-x-auto border border-gray-400 rounded print:overflow-visible">
            <table className="w-full text-left border-collapse text-sm min-w-[600px] print:min-w-0 print:w-full print:text-xs">
              <thead>
              ...
              <tbody className="divide-y divide-gray-400">
                ...
                <tr>
                  <td className="p-1.5 border-r border-gray-400 text-center print:p-1">
                    <input type="checkbox" name="divisionPreHifz.active" checked={formData.divisionPreHifz?.active || false} onChange={handleChange} className="w-4 h-4 accent-orange-600 print:w-3 print:h-3" />
                  </td>
                ...
                <tr>
                  <td className="p-1.5 border-r border-gray-400 text-center print:p-1">
                    <input type="checkbox" name="divisionHifz.active" checked={formData.divisionHifz?.active || false} onChange={handleChange} className="w-4 h-4 accent-orange-600 print:w-3 print:h-3" />
                  </td>
